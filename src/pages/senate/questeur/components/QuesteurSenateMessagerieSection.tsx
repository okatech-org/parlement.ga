...
export const QuesteurSenateMessagerieSection = () => {
  const messages = [
    { id: 1, sender: "Service Financier", subject: "Validation budget décembre", date: "Il y a 3h", unread: true },
    { id: 2, sender: "Fournisseur ABC", subject: "Livraison matériel", date: "Hier", unread: false },
  ];
