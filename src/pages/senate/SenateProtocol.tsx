...
import {
    ...
    Scale, ChevronRight, Crown, MessageSquare, CheckCircle,
    Clock, Calendar, Send, Home, Building, Sun, Moon
} from "lucide-react";
...
/**
 * Page Protocole Sénat - Contenu éducatif public
 * Présente le fonctionnement et les rôles du Sénat
 */
const SenateProtocol = () => {
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-serif font-bold text-foreground">Protocole Sénat</h1>
                                <p className="text-xs text-muted-foreground">Fonctionnement de la chambre haute</p>
                            </div>
                        </div>
            ...
            <section className="py-16 bg-gradient-to-br from-primary/5 to-primary/10">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
                        ...
                        Voix des collectivités locales au sein du Parlement.
                    </p>
                </div>
            </section>
            ...
            <div className="container mx-auto px-4 py-12">
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                    <TabsList className="mb-8 flex justify-center flex-wrap">
                        ...
                        <TabsTrigger value="roles">Rôles & Missions</TabsTrigger>
