...
export const VPSenateDashboardSection = () => {
  ...
  const commissionData = [
    { name: "Lois", value: 35, color: "#22c55e" },
    { name: "Finances", value: 25, color: "#3b82f6" },
    { name: "Affaires Sociales", value: 20, color: "#f59e0b" },
    { name: "Collectivités", value: 20, color: "#8b5cf6" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="flex flex-col justify-center items-center p-6 bg-gradient-to-br from-primary/5 to-transparent">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <GroupDistributionChart title="Répartition des Commissions Supervisées" data={commissionData} />
        <LawProgressChart title="Avancement des Textes Prioritaires" data={textProgress} />
      </motion.div>
    </motion.div>
  );
};
