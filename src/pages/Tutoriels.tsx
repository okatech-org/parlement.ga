                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6 sm:space-y-8">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            ...
                            <Button variant="outline" size="sm">{t('tutorials.catalog')}</Button>
                        </div>

                        <div className="grid gap-4 sm:gap-6">
                            {tutorials.map((tutorial) => (
                                <Card key={tutorial.id} className="p-3 sm:p-4 hover:shadow-elegant transition-all group cursor-pointer border-border/50">
                                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                        <div className="relative w-full sm:w-32 md:w-40 h-36 sm:h-24 rounded-lg overflow-hidden flex-shrink-0">
                                            <img
                                                src={tutorial.image}
                                                alt={tutorial.title}
