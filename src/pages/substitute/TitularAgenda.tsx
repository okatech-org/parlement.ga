...
const TitularAgenda = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div>
                <h1 className="text-3xl font-serif font-bold text-foreground">Agenda du Titulaire</h1>
                <p className="text-muted-foreground">Consultez l'agenda de l'Honorable Député Titulaire.</p>
            </div>

            <div className="grid gap-4">
                {events.map((event) => (
                    <Card key={event.id} className="p-6 border-l-4 border-l-teal-500 border-y border-r border-border/50 hover:shadow-md transition-all">
