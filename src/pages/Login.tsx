...
export default function Login() {
    ...
    const handlePinSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isNewUser) {
                ...
                sessionStorage.setItem(`account_type_${phoneNumber}`, accountType || "citoyen");
                toast.success(t('common.success'));
    ...
    const handleSuccessfulLogin = () => {
        login(phoneNumber, accountType || "citoyen");
    };

    return (
        <div className="min-h-screen bg-background transition-colors duration-300 flex flex-col" dir={dir}>
            {/* Header */}
            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <Card className="w-full max-w-md p-8 shadow-2xl border-border/50 bg-card/80 backdrop-blur-sm">
                    {/* Mode Switcher */}
                    ...
                    {mode === "register" && step === "account-type" && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            <div className="text-center mb-6">
                                <h2 className="text-xl font-bold mb-2">{t('common.create')}</h2>
