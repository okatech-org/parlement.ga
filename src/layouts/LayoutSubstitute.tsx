...
const LayoutSubstitute = ({ children }: { children: React.ReactNode }) => {
        ...
        <div className="min-h-screen bg-background flex" dir={dir}>
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="p-6 border-b border-border/50">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-12 h-12 rounded-full bg-teal-500/10 flex items-center justify-center text-teal-600 font-bold text-xl">
                                S
                            </div>
                            <div>
                                <h3 className="font-bold text-sm">{user?.name || "M. Suppléant"}</h3>
                                <p className="text-xs text-muted-foreground">Député Suppléant</p>
                            </div>
                        </div>
                        <RoleSwitcher />
                    </div>
                                ...
                                {menuItems.map((item, index) => (
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            location.pathname === item.path && "bg-teal-500/10 text-teal-600 hover:bg-teal-500/15"
                                        )}
                    ...
                    <div className="p-4 border-t border-border/50 space-y-2">
                        ...
                        <Button
                            variant="ghost"
                            className="w-full justify-start gap-3"
                            onClick={() => navigate("/suppleant/settings")}
                        >
            ...
            <main className="flex-1 overflow-y-auto h-screen">
                ...
                <div className="lg:hidden p-4 border-b border-border flex items-center justify-between bg-background sticky top-0 z-30">
                    ...
                    <h1 className="font-bold">Espace Suppléant</h1>
...
export default LayoutSubstitute;
